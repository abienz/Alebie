...
$TARGET_EMAIL = array("^webmaster@alebie\.com$");

			/* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","abuse@alebie.com");
...
function LoadBuiltinLanguage()
{
	...
	$aMessages[MSG_LOG_OK] = 'OK';
		...
		// Parameters: none
	$aMessages[MSG_THANKS_PAGE] = 'Thanks!  I\'ve received your information, '.
